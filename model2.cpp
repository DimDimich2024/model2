...
// model2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cmodel2App, CWinApp)
...
// Единственный объект Cmodel2App

Cmodel2App theApp;


// Инициализация Cmodel2App

BOOL Cmodel2App::InitInstance()
{
